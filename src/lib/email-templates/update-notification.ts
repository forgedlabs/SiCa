...
export function generateUpdateEmail(data: UpdateNotificationData): string {
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; background-color: #ffffff; color: #000000;">
  <table role="presentation" style="width: 100%; border-collapse: collapse; background-color: #ffffff;">
        ...
        <table role="presentation" style="max-width: 600px; width: 100%; border-collapse: collapse; background-color: #ffffff;">
          ...
          <tr>
            <td style="padding: 48px 40px;">
              <h2 style="margin: 0 0 32px 0; font-family: Georgia, serif; font-size: 24px; font-weight: 400; color: #000000; letter-spacing: 0.05em; text-transform: uppercase;">${subject}</h2>
    ...
    `<p style="margin: 0 0 24px 0; font-size: 15px; line-height: 1.8; color: #000000;">${paragraph.replace(/\n/g, '<br>')}</p>`
  ).join('')}
